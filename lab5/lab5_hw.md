...
```
##  [1] "name"       "gender"     "eyecolor"   "race"       "hair_color"
...
```
## # A tibble: 24 × 10
##    name       gender eyeco…¹ race  hair_…² height publi…³ skin_…⁴ align…⁵ weight
...
## # … with 14 more rows, and abbreviated variable names ¹​eyecolor, ²​hair_color,
...
```r
good_people <- filter(superhero_info, alignment== "good")
```


```r
bad_people <- filter(superhero_info, alignment== "bad")
```
...
```
## # A tibble: 3 × 10
##   name      gender eyecolor race   hair_…¹ height publi…² skin_…³ align…⁴ weight
##   <chr>     <chr>  <chr>    <chr>  <chr>    <dbl> <chr>   <chr>   <chr>    <dbl>
## 1 Sif       Female blue     Asgar… Black      188 Marvel… <NA>    good       191
## 2 Thor      Male   blue     Asgar… Blond      198 Marvel… <NA>    good       288
## 3 Thor Girl Female blue     Asgar… Blond      175 Marvel… <NA>    good       143
...
##  8 Darkseid   Male   red     New … No Hair  267   DC Com… grey    bad        817
##  9 Doctor Do… Male   brown   Human Brown    201   Marvel… <NA>    bad        187
## 10 Doctor Do… Male   brown   <NA>  Brown    201   Marvel… <NA>    bad        132
## # … with 14 more rows, and abbreviated variable names ¹​eyecolor, ²​hair_color,
## #   ³​publisher, ⁴​skin_color, ⁵​alignment
```

9. OK, so are there more good guys or bad guys that are bald (personal interest)?
According to the data, there are more good people that are bald than there are bad. 
...
## # … with 27 more rows, and abbreviated variable names ¹​eyecolor, ²​hair_color,
## #   ³​publisher, ⁴​skin_color, ⁵​alignment
```
...
## # … with 25 more rows, and abbreviated variable names ¹​eyecolor, ²​hair_color,
## #   ³​publisher, ⁴​skin_color, ⁵​alignment
```
...
## # … with abbreviated variable names ¹​eyecolor, ²​hair_color, ³​publisher,
...
## #   abbreviated variable names ¹​eyecolor, ²​hair_color, ³​publisher, ⁴​skin_color,
## #   ⁵​alignment
```
...
##   <chr>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl> 
## 1 Hercul… FALSE   TRUE    FALSE   FALSE   FALSE   TRUE    FALSE   FALSE   FALSE 
