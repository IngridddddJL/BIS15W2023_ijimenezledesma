...
homerange %>% 
  ...
  geom_histogram(alpha = 100, color = "darkmagenta", fill = "deeppink1", bins=40)+
...
homerange %>% 
  ...
  geom_histogram(alpha = 100, color = "seagreen", fill = "pink", bins=40)+
  labs(title = "Distribution of Body Mass")
```
...
homerange %>% 
  ggplot(aes(x=log10.hra)) +
  geom_histogram(aes(y = ..density..), fill = "pink", alpha = 0.4, color = "black")+
  geom_density(color = "red")+
  labs(title = "Distribution of Body Mass")
```
