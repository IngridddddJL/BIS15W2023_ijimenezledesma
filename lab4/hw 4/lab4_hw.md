...
On average herbivores have a larger 'meaen.hra.m2' according to this data. 
...
```r
deer <- select(deer, log10.mass, family, genus, species)
```
...
```
## # A tibble: 12 × 4
##    log10.mass family   genus      species    
##         <dbl> <chr>    <chr>      <chr>      
##  1       3.88 cervidae pudu       puda       
##  2       4.13 cervidae muntiacus  reevesi    
##  3       4.38 cervidae capreolus  capreolus  
##  4       4.47 cervidae cervus     nippon     
##  5       4.54 cervidae ozotoceros bezoarticus
##  6       4.73 cervidae odocoileus hemionus   
##  7       4.80 cervidae axis       axis       
##  8       4.85 cervidae dama       dama       
##  9       4.94 cervidae odocoileus virginianus
## 10       5.01 cervidae rangifer   tarandus   
## 11       5.37 cervidae cervus     elaphus    
## 12       5.49 cervidae alces      alces
```
...
The Namaqua Snake is the one with the smallest homerange. They also, feed on lizards and rain frogs!
...
```r
smallest_snakes <- filter(snakes, mean.hra.m2 == 200)
smallest_snakes
```
